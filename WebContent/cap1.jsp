...
<html lang="pt-br" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Capítulo 1 - Principios da programação</title>
  ...
  <div id="msg" class="container">
   <div id="msg-top" style="padding:10px 0px;">
    ...
    <div id="home">
      <div class="text">
        <h1>Algoritmos</h1>
        <h3>PRINCÍPIOS DA PROGRAMAÇÃO</h3>
    ...
    <br><br><br>
      <div class="container">
        <h1 class="display-4">Principios da programação</h1><br><br>
        <div class="row">
          <div class="col-1"></div>
            <div class="col-9">
              <div class="box">
                  <iframe src="pdf/cap1.pdf" width="850" height="800" style="border: none;"></iframe>
              </div>
            </div>
          </div>
      </div>
